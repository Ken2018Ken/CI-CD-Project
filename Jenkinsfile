...
pipeline {
    ...
    parameters
    {
        ...
        string(name: 'aws_account_id', description: " AWS Account ID", defaultValue: '801165609210')
        string(name: 'Region', description: "Region of ECR", defaultValue: 'us-east-1')
        string(name: 'ImageName', description: "name of the docker build", defaultValue: 'javaapp')
        string(name: 'ImageTag', description: "tag of the docker build", defaultValue: 'v1')
        string(name: 'DockerHubUser', description: "name of the Application", defaultValue: 'kenwiz')
    ...
    stages{
        ...
        stage('Git Checkout'){
            ...
            gitCheckout(
                branch: "main",
                url: "https://github.com/Ken2018Ken/CI-CD-Project.git"
            )
            }
        }
         /* 
